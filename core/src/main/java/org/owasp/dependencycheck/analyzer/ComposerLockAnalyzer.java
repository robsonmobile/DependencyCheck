    ...
    protected void analyzeDependency(Dependency dependency, Engine engine) throws AnalysisException {
        ...
        try (FileInputStream fis = new FileInputStream(dependency.getActualFile())) {
            ...
            clp.getDependencies().stream().map((dep) -> {
                ...
                try {
                    PackageURL purl = PackageURLBuilder.aPackageURL().withType("composer").withNamespace(dep.getGroup())
                    ...
                    d.addSoftwareIdentifier(new GenericIdentifier("cocoapods:" + dep.getGroup() + "/" + dep.getProject() + "@" + dep.getVersion(), Confidence.HIGHEST));
                }
