...
public class RubyBundleAuditAnalyzer extends AbstractFileTypeAnalyzer {
    ...
    private Vulnerability createVulnerability(String parentName, Dependency dependency, String gem, String nextLine) throws CpeValidationException {
        ...
        if (null != dependency) {
            ...
            try {
                PackageURL purl = PackageURLBuilder.aPackageURL().withType("gem").withName(dependency.getName())
                ...
                GenericIdentifier id = new GenericIdentifier("gem:" + dependency.getName() + "@" + dependency.getVersion(),
                        Confidence.HIGHEST);
